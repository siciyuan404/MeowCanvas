...
const RECOMMENDED_APIS = [
    ...
    },
    {
        ...
        tagKeys:['api.tagImageModels','api.tagVideoModels','api.tagLlmModels'],
        icons:['IMG','VID','LLM'],
        summaryKey:'api.recommendOpenaiSummary',
        advantages:['官方直连，稳定可靠', '图像/视频/LLM 全覆盖', '支持 Sora 2 视频生成'],
    ...
    },
    {
        ...
        tagKeys:['api.tagImageModels','api.tagVideoModels','api.tagLlmModels'],
        icons:['IMG','VID','LLM'],
        summaryKey:'api.recommendGeminiSummary',
        advantages:['官方免费额度可用', 'Nano Banana 2 文生图', 'Veo 3 视频生成'],
        image_models:['gemini-2.5-flash-image-preview', 'imagen-4.0-generate-001', 'imagen-4.0-ultra-001'],
        chat_models:['gemini-2.5-pro', 'gemini-2.5-flash'],
        video_models:['veo-3.0', 'veo-3.1']
    },
    {
        id:'bfl',
        name:'BFL',
        ...
        protocol:'bfl',
        register_url:'https://bfl.ai',
        tagKeys:['api.tagImageModels'],
        icons:['IMG'],
        summaryKey:'api.recommendBflSummary',
        advantages:['Flux 官方 API', 'Flux Kontext 图像编辑', '异步轮询机制'],
        image_models:['flux-kontext-max', 'flux-kontext-pro', 'flux-1.1-pro', 'flux-1.1-pro-ultra']
    },
    {
        id:'wavespeed',
        name:'WaveSpeed',
        ...
        protocol:'wavespeed',
        register_url:'https://wavespeed.ai',
        tagKeys:['api.tagImageModels','api.tagVideoModels'],
        icons:['IMG','VID'],
        summaryKey:'api.recommendWavespeedSummary',
        advantages:['图像与视频全覆盖', '支持 Sora 2 / Veo 3 / 可灵', '统一异步轮询接口'],
        image_models:['flux-1.1-pro', 'flux-kontext-max', 'seedream-4.0', 'nano-banana'],
        video_models:['sora-2', 'veo-3.0', 'kling-v2.1', 'wan-2.5']
    },
    {
        id:'kie',
        name:'Kie.AI',
        ...
        protocol:'kie',
        register_url:'https://kie.ai',
        tagKeys:['api.tagImageModels','api.tagVideoModels'],
        icons:['IMG','VID'],
        summaryKey:'api.recommendKieSummary',
        advantages:['统一任务接口', '图像与视频全覆盖', '支持 Sora 2 / Veo 3'],
        image_models:['flux-1.1-pro', 'flux-kontext-max', 'seedream-4.0', 'nano-banana'],
        video_models:['sora-2', 'veo-3.0', 'kling-v2.1', 'wan-2.5']
    },
    {
        ...
        protocol:'evolink',
        register_url:'https://evolink.ai',
        tagKeys:['api.tagVideoModels'],
        icons:['VID'],
        summaryKey:'api.recommendEvolinkSummary',
        advantages:['专注视频生成', '支持 Sora 2 / Veo 3 / 可灵', '异步轮询机制'],
        video_models:['sora-2', 'veo-3.0', 'kling-v2.1']
    },
    {
        id:'suno',
        name:'Suno',
        ...
        protocol:'suno',
        register_url:'https://suno.com',
        tagKeys:['api.tagMusicModels'],
        icons:['MUS'],
        summaryKey:'api.recommendSunoSummary',
        advantages:['AI 音乐生成', '支持 Suno v4.5', '异步任务轮询'],
        music_models:['suno-v4.5', 'suno-v4', 'suno-v3.5']
    },
    {
        id:'mureka',
        name:'Mureka',
        ...
        protocol:'mureka',
        register_url:'https://mureka.ai',
        tagKeys:['api.tagMusicModels'],
        icons:['MUS'],
        summaryKey:'api.recommendMurekaSummary',
        advantages:['AI 音乐生成', '支持歌曲/歌词/配乐', '多端点支持'],
        music_models:['mureka-v4', 'mureka-v3.5', 'mureka-v3']
    }
];
